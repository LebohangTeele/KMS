                        ...
                        <font class='title'>
                            ...
                            <table border='0' cellspacing='0' cellpadding='2' bgcolor='white' width='270' style='line-height: 1.25;'>
                                <tr>
                                    ...
                                    <td align='right'>Date: <?php echo date("d/m/Y"); ?>
                                        ...
                                        <br>
                                        Ticket #: <?php echo $quotation_number ?>
                                        <br>
                            ...
                            <table border='0' cellspacing='0' cellpadding='2' bgcolor='white' width='270' style='line-height: 1.25;'>
                                ...
                                <?php
                                    ...
                                    $currency = "R";
                                    foreach($quote_items as $items):
                                ?>  
                                    <tr>
                                        <td>
                                            <?php echo  $items['number']. "&nbsp;" .$items['name']; ?>
                                            <br>
                                        ...
                                        <td width='50'>
                                            <br>
                                            <br>
                                            <?php echo number_format(($items['price'] * $items['qty'])*2,'2','.',',');?>
                                        </td>
                                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td align='right' style='font-weight: bold;'>
                                    <?php echo $currency . $quote_items['total']*0.15; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align='left'>
