            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="widget-wrap block-header margin-bottom-0 clearfix">
                        <table class="table table-striped data-tbl" id="thisone">
                            <thead>
                                <tr>
                                    <td>
                                        State
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action = "">
                                                    <input type="hidden" id="<?php echo $inv['invoice_number'];?>" value ="<?php echo $inv['quote_id'];?>">
                                                    <input type="submit" value="details" onclick ="return <?php echo $inv['invoice_number'].'chk()'; ?> ">
                                                </form>
                                            </td>
                                        </tr>
                                <?php
                ...
                <div class="col-md-6" id="refundDetails">
...
<script>
        <?php
            foreach($invoices as $inv):
        ?>
            function <?php echo $inv['invoice_number'].'chk()'; ?>
            {
                var name = document.getElementById('<?php echo $inv['invoice_number'];?>').value;
                var dataString = '<?php echo $inv['invoice_number']."=";?>'+name;
                $.ajax({
                        type:"POST",
                        url: "<?php echo base_url('sales_dashboard/refund_details');?>",
                        data:dataString,
                        cache:false,
                        success:function (datarangu){
                            $('#refundDetails').html(datarangu);
                        }
                    });
